...
func (_c *UserCreate) SetAuthSource(v user.AuthSource) *UserCreate {
	_c.mutation.SetAuthSource(v)
	return _c
}

// SetNillableAuthSource sets the "auth_source" field if the given value is not nil.
func (_c *UserCreate) SetNillableAuthSource(v *user.AuthSource) *UserCreate {
	if v != nil {
		_c.SetAuthSource(*v)
	}
	return _c
...
func (_c *UserCreate) SetAuthRealm(v string) *UserCreate {
	_c.mutation.SetAuthRealm(v)
	return _c
}

// SetNillableAuthRealm sets the "auth_realm" field if the given value is not nil.
func (_c *UserCreate) SetNillableAuthRealm(v *string) *UserCreate {
	if v != nil {
		_c.SetAuthRealm(*v)
	}
	return _c
...
func (_c *UserCreate) SetCanManageAllShares(v bool) *UserCreate {
	_c.mutation.SetCanManageAllShares(v)
	return _c
}

// SetNillableCanManageAllShares sets the "can_manage_all_shares" field if the given value is not nil.
func (_c *UserCreate) SetNillableCanManageAllShares(v *bool) *UserCreate {
	if v != nil {
		_c.SetCanManageAllShares(*v)
	}
	return _c
}

// SetCanManageUsers sets the "can_manage_users" field.
func (_c *UserCreate) SetCanManageUsers(v bool) *UserCreate {
	_c.mutation.SetCanManageUsers(v)
	return _c
}

// SetNillableCanManageUsers sets the "can_manage_users" field if the given value is not nil.
func (_c *UserCreate) SetNillableCanManageUsers(v *bool) *UserCreate {
	if v != nil {
		_c.SetCanManageUsers(*v)
	}
	return _c
}
...
func (_c *UserCreate) AddShareIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddShareIDs(ids...)
	return _c
}

// AddShares adds the "shares" edges to the Share entity.
func (_c *UserCreate) AddShares(v ...*Share) *UserCreate {
...
func (_c *UserCreate) defaults() {
	...
	if _, ok := _c.mutation.CanManageAllShares(); !ok {
		v := user.DefaultCanManageAllShares
		_c.mutation.SetCanManageAllShares(v)
	}
	if _, ok := _c.mutation.CanManageUsers(); !ok {
		v := user.DefaultCanManageUsers
		_c.mutation.SetCanManageUsers(v)
	}
...
func (_c *UserCreate) check() error {
	...
	if _, ok := _c.mutation.CanManageAllShares(); !ok {
		return &ValidationError{Name: "can_manage_all_shares", err: errors.New(`ent: missing required field "User.can_manage_all_shares"`)}
	}
	if _, ok := _c.mutation.CanManageUsers(); !ok {
		return &ValidationError{Name: "can_manage_users", err: errors.New(`ent: missing required field "User.can_manage_users"`)}
	}
	if _, ok := _c.mutation.Disabled(); !ok {
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.AuthRealm(); ok {
		_spec.SetField(user.FieldAuthRealm, field.TypeString, value)
		_node.AuthRealm = &value
	}
	...
	if value, ok := _c.mutation.CanManageAllShares(); ok {
		_spec.SetField(user.FieldCanManageAllShares, field.TypeBool, value)
		_node.CanManageAllShares = value
	}
	if value, ok := _c.mutation.CanManageUsers(); ok {
		_spec.SetField(user.FieldCanManageUsers, field.TypeBool, value)
		_node.CanManageUsers = value
	}
