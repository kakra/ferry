...
func (s *Server) routes() {
	...
	admin.POST("/admin/users/:id/toggle-disabled", s.handleToggleUserDisabled)
	admin.POST("/admin/users/:id/password", s.handleResetUserPassword)
	admin.POST("/admin/users/:id/delete", s.handleDeleteUser)
	admin.POST("/admin/users/:id/permissions/:perm", s.handleUpdateUserPermission)
